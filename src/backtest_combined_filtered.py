...
"""
Create monthly deciles based on the filtered combined score.
"""
...
"""
Long the highest-score decile and short the lowest-score decile.
"""
...
def main():
    ...
    input_file = data_dir / "combined_factor_filtered.csv"
    output_file = data_dir / "combined_filtered_backtest.csv"
    summary_file = data_dir / "combined_filtered_backtest_summary.csv"
    cumulative_file = data_dir / "combined_filtered_cumulative_returns.csv"
